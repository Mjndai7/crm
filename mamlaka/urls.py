...
urlpatterns = [
    ...
    path('api/clients/', include('clients.urls')), #path to our client's endpoints

    path('api/products/', include('products.urls')), #path to our product's endpoints
